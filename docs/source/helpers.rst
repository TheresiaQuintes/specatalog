...
- The module ``full_measurement`` provides a function that combines the workflow for the creation of a new measurement entry and the creation of the corresponding directory in the archive folder.
