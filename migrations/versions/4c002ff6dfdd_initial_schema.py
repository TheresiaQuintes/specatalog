...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "solvent", sa.Enum("toluene", "water", name="solvents"), nullable=False
        ),
        sa.Column("concentration", sa.String(length=512), nullable=True),
        sa.Column("date", sa.Date(), nullable=False),
        sa.Column(
            "measured_by",
            sa.Enum("richert", "maylaender", "thielert", name="names"),
            nullable=False,
        ),
        sa.Column("location", sa.String(length=512), nullable=True),
        sa.Column(
            "device",
            sa.Enum("leer", "elexsys", "emx_nano", name="devices"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_measurements_molecular_id"),
        "measurements",
        ["molecular_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "linker",
            sa.Enum("bi", "co", "sup_h_tz", "xylene", name="linker"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "doublet",
            sa.Enum("no1", "no2", "no3", "no4", "no5", "tri", name="doublets"),
            nullable=False,
        ),
        sa.Column(
            "linker",
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency_band",
            sa.Enum("leer", "s", "x", "q", "w", name="frequencybands"),
            nullable=False,
        ),
